...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'shell_sage.config': { 'shell_sage.config.ShellSageConfig': ('config.html#shellsageconfig', 'shell_sage/config.py'),
            ...
            'shell_sage.core': { 'shell_sage.core.OllamaClient': ('core.html#ollamaclient', 'shell_sage/core.py'),
                                 'shell_sage.core.OllamaClient.__call__': ('core.html#ollamaclient.__call__', 'shell_sage/core.py'),
                                 'shell_sage.core.OllamaClient.__init__': ('core.html#ollamaclient.__init__', 'shell_sage/core.py'),
